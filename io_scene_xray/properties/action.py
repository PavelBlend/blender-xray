...
class XRayActionProperties(bpy.types.PropertyGroup):
    ...
    flags_fx = properties.gen_flag_prop(mask=0x01, description='Type FX')
    flags_stopatend = properties.gen_flag_prop(mask=0x02, description='Stop at end')
    flags_nomix = properties.gen_flag_prop(mask=0x04, description='No mix')
    flags_syncpart = properties.gen_flag_prop(mask=0x08, description='Sync part')
