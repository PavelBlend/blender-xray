...
def _export(bpy_obj, cwriter, context):
    ...
    for bone, obj in bones:
        ...
        pwriter.putf('ff', math.radians(xray.ikjoint.lim_x_min), math.radians(xray.ikjoint.lim_x_max))
        pwriter.putf('ff', xray.ikjoint.lim_x_spr, xray.ikjoint.lim_x_dmp)
        pwriter.putf('ff', math.radians(xray.ikjoint.lim_y_min), math.radians(xray.ikjoint.lim_y_max))
        pwriter.putf('ff', xray.ikjoint.lim_y_spr, xray.ikjoint.lim_y_dmp)
        pwriter.putf('ff', math.radians(xray.ikjoint.lim_z_min), math.radians(xray.ikjoint.lim_z_max))
