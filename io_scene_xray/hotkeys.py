...
keymap_items_list = (
    ...
    (bones.ops.XRAY_OT_import_bones, 'F5', False, True, False),
    (bones.ops.XRAY_OT_export_bones, 'F5', False, True, True),
    (dm.ops.XRAY_OT_import_dm, 'F6', False, True, False),
    (dm.ops.XRAY_OT_export_dm, 'F6', False, True, True),
    (details.ops.XRAY_OT_import_details, 'F7', False, True, False),
    (details.ops.XRAY_OT_export_details, 'F7', False, True, True),
    (scene.ops.XRAY_OT_import_scene_selection, 'F8', False, True, False),
