...
translations_table = (
    ...
    # level panel
    (iface.level_type, 'Тип'),
    (iface.level, 'Уровень'),
    (iface.visual, 'Визуал'),
    (iface.cform, 'Форма Коллизии'),
    (iface.normal, 'Нормальный'),
    (iface.hierrarhy, 'Иерархичный'),
    (iface.progressive, 'Прогрессивный'),
    (iface.tree_st, 'Статичное Дерево'),
    (iface.tree_pm, 'Прогрессивное Дерево'),
    (iface.lod, 'Уровень Детализации'),
    (iface.sectors_obj, 'Объект Секторов'),
    (iface.portals_obj, 'Объект Порталов'),
    (iface.lights_obj, 'Объект Света'),
    (iface.glows_obj, 'Объект Свечений'),
    (iface.sector_front, 'Передний Сектор'),
    (iface.sector_back, 'Задний Сектор'),
    (iface.visual_type, 'Тип Визуала'),
    (iface.color_scale, 'Шкала Цвета'),
    (iface.color_bias, 'Погрешность Цвета'),
    (iface.use_fastpath, 'Использовать Ускоренный Путь'),
    (iface.controller, 'Контроллер'),
    (iface.light_type, 'Тип Света'),
    (iface.static, 'Статичный'),
    (iface.spot, 'Прожектор'),
    (iface.diffuse, 'Диффузный Свет'),
    (iface.specular, 'Бликовый Свет'),
    (iface.ambient, 'Фоновый Свет'),
    (iface.cutoff_range, 'Предел Действия'),
    (iface.falloff, 'Спад'),
    (iface.attenuation_0, 'Постоянное Затухание'),
    (iface.attenuation_1, 'Линейное Затухание'),
    (iface.attenuation_2, 'Квадратичное Затухание'),
    (iface.theta, 'Внутренний Угол Тета'),
    (iface.phi, 'Внешний Угол Фи')
